...
import com.easy.archiecture.annotation.CachePut;
...
public class CacheImpl {
    ...
    @Pointcut("@annotation(com.easy.archiecture.annotation.Cache)")
    public void cacheMethod() {
    }

    @Pointcut("@annotation(com.easy.archiecture.annotation.CachePut)")
